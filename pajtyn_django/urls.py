...
urlpatterns = [
    ...
    path('new_account/', views.register_view, name='register'),
    ...
    path('kebaby_lokale/<int:kebaby_lokale_id>/kebab/<int:kebaby_dania_id>/', views.kebab_view, name='kebab_danie_view'),
